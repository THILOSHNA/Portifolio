...
// point Light
const point_light_lnk = new THREE.PointLight(0xffc0cb, 20, 10, Math.PI / 4);
point_light_lnk.position.set(-18, 9, -7);
scene.add(point_light_lnk);

// const pointLightHelper = new THREE.PointLightHelper(point_light_lnk);
// scene.add(pointLightHelper);

const point_light2 = new THREE.PointLight(0xff0000, 100, 15, Math.PI / 4);
point_light2.position.set(10, 5, 4);
...
const point_light4 = new THREE.PointLight(0xaf47d2, 35, 15, Math.PI / 4);
point_light4.position.set(4, 8, -4);
...
//   stats.update();
  ...
  now = Date.now();
    ...
    if (delta > interval) {
        ...
        // Update CSS3DObject position to ensure it stays in correct depth
